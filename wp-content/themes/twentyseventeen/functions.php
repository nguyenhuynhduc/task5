...
add_action('wp_ajax_checkedCheckbox', 'random_function');
add_action('wp_ajax_nopriv_checkedCheckbox', 'random_function');
function random_function()
{
    ...
    if($check==null||$check=="no"){
        $wpdb->update($table_name, array("status" => "yes" ),array("ID" => $id));
    }
    else{
